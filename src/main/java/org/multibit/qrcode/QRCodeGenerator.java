...
public class QRCodeGenerator {
    ...
    public BufferedImage generateQRcode(String address, String amount, String label, int scaleFactor) {
        ...
        // Handle CoinSpark address sending Bitcoin, not assets
	if (address.startsWith("s")) {
	    return generateCoinSparkQRcode(address, null, amount, label, scaleFactor);
	}
    ...
    public BufferedImage generateCoinSparkQRcode(String address, String assetRef, String amount, String label) {
	return generateCoinSparkQRcode(address, assetRef, amount, label, 1);
    }
    /**
...
//	System.out.println("coinspark bitcoinURI = " + bitcoinURI);
    ...
    /*
    Refactored this code into a method that can be used by others.
    
    Generate a qr code image from string, given a scale factor.
    
    @param  bitcoinURI
    @param  scaleFactor
    @return image
    */
    public BufferedImage generateImageFromURI(String bitcoinURI, int scaleFactor) {
