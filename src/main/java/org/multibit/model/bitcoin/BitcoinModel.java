...
//import org.coinsparks.CSAssetDatabase;
...
public class BitcoinModel extends AbstractModel<CoreModel> {
    ...
    // CoinSpark START
    public static final BigInteger COINSPARK_SEND_MINIMUM_AMOUNT = new BigInteger("10000");
    // CoinSpark END
    ...
    public static final String WALLET_FILE_EXTENSION = "sparkwallet";
