...
public class ViewFactory {
  ...
  private Viewable createView(View viewNumber) {
    ...
    switch (viewNumber) {
      ...
      /*CoinSpark START*/
      case COINSPARK_ASSETS_VIEW: {
        viewToReturn = new CSShowAssetsPanel(this.bitcoinController, mainFrame);
        break;
      }
      case COINSPARK_DEVELOPER_TOOLS_VIEW: {
        viewToReturn = new CSDeveloperToolsPanel(this.bitcoinController, mainFrame);
        break;
      }
      case COINSPARK_MIGRATE_ASSETS_VIEW: {
	  viewToReturn = new CSMigrateAssetsPanel(this.bitcoinController, mainFrame);
        break;
      }
      /*CoinSpark END*/
