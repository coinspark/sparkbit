...
public class AddressBookTableModel extends DefaultTableModel {
    ...
    public AddressBookTableModel(BitcoinController bitcoinController, boolean isReceiving) {
	    ...
	    /* CoinSpark START */
	    // Only holds bitcoin, not coinspark.
	    if (isReceiving && tableHeaderKey.equals("addressBookTableModel.addressColumnHeader"))
		tableHeaderKey = "addressBookTableModel.addressColumnHeader.receivePanel";
	    /* CoinSpark END */
