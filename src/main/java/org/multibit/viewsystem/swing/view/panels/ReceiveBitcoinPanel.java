...
public class ReceiveBitcoinPanel extends AbstractTradePanel implements Viewable {
    ...
    protected JPanel createFormPanel(JPanel formPanel, GridBagConstraints constraints) {
        ...
        MultiBitLabel sparkAddressLabel = new MultiBitLabel(controller.getLocaliser().getString("receiveBitcoinPanel.sparkAddressLabel"));
        sparkAddressLabel.setToolTipText(HelpContentsPanel.createTooltipText(controller.getLocaliser().getString("receiveBitcoinPanel.sparkAddressLabel.tooltip")));
        sparkAddressLabel.setBorder(BorderFactory.createMatteBorder((int)(TEXTFIELD_VERTICAL_DELTA * 0.5), 0, (int)(TEXTFIELD_VERTICAL_DELTA * 0.5), 0, ColorAndFontConstants.VERY_LIGHT_BACKGROUND_COLOR));
        sparkAddressLabel.setHorizontalAlignment(JLabel.TRAILING);
        constraints.fill = GridBagConstraints.BOTH;
        constraints.gridx = 0;
        constraints.gridy = 2;
        constraints.weightx = 1;
        ...
        constraints.gridheight = 1;
        constraints.anchor = GridBagConstraints.LINE_END;
        formPanel.add(sparkAddressLabel, constraints);
        ...
        constraints.gridheight = 1;
        constraints.anchor = GridBagConstraints.LINE_START;
        formPanel.add(sparkAddressTextField, constraints);
        
        copyIcon = ImageLoader.createImageIcon(ImageLoader.COPY_ICON_FILE);
        CopyReceiveSparkAddressAction copySparkAddressAction = new CopyReceiveSparkAddressAction(controller, this, copyIcon);
        MultiBitButton copySparkAddressButton = new MultiBitButton(copySparkAddressAction, controller);
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridx = 6;
        constraints.gridy = 2;
        constraints.weightx = 1;
...
//		.getHeight() * AbstractTradePanel.PREFERRED_NUMBER_OF_LABEL_ROWS + TEXTFIELD_VERTICAL_DELTA + 6));
	...
	formPanel.add(labelScrollPane, constraints);
        ...
        constraints.weighty = 1; //0.2;
        constraints.gridwidth = 1;
        constraints.gridheight = 1;
        constraints.anchor = GridBagConstraints.LINE_END;
// Disable, don't show amount field
...
*/
    ...
    /* CoinSpark START */
    public String getReceiveSparkAddress() {
...
//        return ImageLoader.createImageIcon(ImageLoader.RECEIVE_BITCOIN_ICON_FILE);
	...
	return "Request bitcoin or assets from someone";
