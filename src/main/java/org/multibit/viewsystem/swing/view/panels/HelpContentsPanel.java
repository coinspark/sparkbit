...
public class HelpContentsPanel extends JPanel implements Viewable {
    ...
    /*CoinSpark START */
    public static final String HELP_ASSETS_URL = "help_assets.html";
    /*CoinSpark END */
    ...
    public static String createTooltipTextForMenuItem(String tooltip) {
        ...
        String lookAndFeel = "" + SparkBit.getController().getModel().getUserPreference(CoreModel.LOOK_AND_FEEL);
    ...
    public static String createMultilineTooltipText(String[] toolTips) {
        ...
        FontSizer.INSTANCE.initialise(SparkBit.getController());
