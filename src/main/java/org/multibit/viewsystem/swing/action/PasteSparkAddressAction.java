 ...
 */
public class PasteSparkAddressAction extends AbstractAction {
     ...
     */
    public PasteSparkAddressAction(BitcoinController bitcoinController, SendBitcoinPanel sendBitcoinPanel, ImageIcon icon) {
        super("", icon);
        ...
        putValue(SHORT_DESCRIPTION, controller.getLocaliser().getString("pasteSparkAddressAction.tooltip"));
        //putValue(MNEMONIC_KEY, mnemonicUtil.getMnemonic("pasteAddressAction.mnemonicKey"));
        // Don't clash with regular bitcoin shortcut keys
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (haveFilesChanged) {
            ...
            // form loads
            this.bitcoinController.getModel().setActiveWalletPreference(BitcoinModel.SEND_SPARK_ADDRESS, stringToPaste);
