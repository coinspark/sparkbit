 ...
 */
public class CopyReceiveSparkAddressAction extends AbstractAction {
     ...
     * @param copyIcon
     */
    public CopyReceiveSparkAddressAction(Controller controller, ReceiveBitcoinPanel receiveBitcoinPanel, ImageIcon copyIcon) {
        super("", copyIcon);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        textTransfer.setClipboardContents(receiveBitcoinPanel.getReceiveSparkAddress());
    }
}