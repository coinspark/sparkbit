...
public class Validator {
	...
	this.bitcoinController.getModel().setActiveWalletPreference(BitcoinModel.VALIDATION_AMOUNT_IS_TOO_BIG_FOR_MIGRATION, amountIsTooBigForMigration.toString());
    ...
    /*CoinSpark*/
//    public boolean validate(String address, String amount, String type) {
//        clearValidationState();
//
//        boolean validAddress = validateAssetAddress(address);
//        boolean validAmount = validateAssetAmount(amount, type);
//        return validAddress && validAmount;
//    }
//
//    private boolean validateAssetAmount(String amount, String type) {
//
//        return bitcoinController.getModel().getAssetsDatabase().validateAmount(amount, type);
//    }
//
//
//    private boolean validateAssetAddress(String address) {
//        return validateAddress(address);   //TBD
//    }
