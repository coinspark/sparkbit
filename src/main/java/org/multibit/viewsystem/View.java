...
public enum View {
    ...
    VERIFY_MESSAGE_VIEW,
    SIGN_MESSAGE_VIEW,
    COINSPARK_ASSETS_VIEW, // CoinSpark : Asset database panel
    COINSPARK_DEVELOPER_TOOLS_VIEW, // CoinSpark : Developer tools panel
    COINSPARK_MIGRATE_ASSETS_VIEW // CoinSpark : Migrate assets panel
    ;
