...
public class ListWalletsResponse implements com.bitmechanic.barrister.BStruct {
    ...
    public static class Builder {
        private String[] _wallets;
        public Builder wallets(String[] wallets) { this._wallets = wallets; return this; }
    ...
    public ListWalletsResponse(java.util.Map _map) throws com.bitmechanic.barrister.RpcException {
        this(
            (String[])com.bitmechanic.barrister.StringTypeConverter.unmarshalList(_map.get("wallets"), false)
        );
    }

    @org.codehaus.jackson.annotate.JsonCreator
    public ListWalletsResponse(
            @org.codehaus.jackson.annotate.JsonProperty("wallets") String[] wallets) {
        super();
