...
public class JSONRPCTransaction implements com.bitmechanic.barrister.BStruct {
    ...
    public static class Builder {
        ...
        public Builder receive_address(String receive_address) { this._receive_address = receive_address; return this; }
        public JSONRPCTransaction build() {
            return new JSONRPCTransaction(this._unixtime, this._confirmations, this._incoming, this._amounts, this._fee, this._txid, this._receive_address);
        }
        ...
        public Builder(JSONRPCTransaction obj) {
            ...
            this._receive_address = obj.getReceive_address();
        }
    }
    ...
    public JSONRPCTransaction(java.util.Map _map) throws com.bitmechanic.barrister.RpcException {
        this(
            ...
            (String)com.bitmechanic.barrister.StringTypeConverter.unmarshal(_map.get("receive_address"), false)
        );
    }
    ...
    public JSONRPCTransaction(
            ...
            @org.codehaus.jackson.annotate.JsonProperty("receive_address") String receive_address) {
        super();
    ...
    public String toString() {
        ...
        sb.append(" receive_address=").append(receive_address);
    ...
    public boolean equals(Object _other) {
        ...
        if (receive_address == null && _o.receive_address != null) { return false; }
        else if (receive_address != null && !receive_address.equals(_o.receive_address)) { return false; }
    ...
    public int hashCode() {
        ...
        _hash = _hash * 31 + (receive_address == null ? 0 : receive_address.hashCode());
