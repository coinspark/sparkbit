...
public class JSONRPCTransaction implements com.bitmechanic.barrister.BStruct {
    ...
    public static class Builder {
        ...
        public Builder message(String message) { this._message = message; return this; }
        public JSONRPCTransaction build() {
            return new JSONRPCTransaction(this._unixtime, this._confirmations, this._category, this._amounts, this._fee, this._txid, this._address, this._payment_ref, this._message);
        }
    ...
    public JSONRPCTransaction(java.util.Map _map) throws com.bitmechanic.barrister.RpcException {
        this(
            ...
            (String)com.bitmechanic.barrister.StringTypeConverter.unmarshal(_map.get("message"), true)
        );
    }
    ...
    public JSONRPCTransaction(
            ...
            @org.codehaus.jackson.annotate.JsonProperty("message") String message) {
        super();
    ...
    public boolean equals(Object _other) {
        ...
        if (message == null && _o.message != null) { return false; }
        else if (message != null && !message.equals(_o.message)) { return false; }
    ...
    public int hashCode() {
        int _hash = 1;
        _hash = _hash * 31 + (message == null ? 0 : message.hashCode());
