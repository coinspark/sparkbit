...
public class SparkBitJSONRPCServiceClient implements SparkBitJSONRPCService {
    ...
    public Boolean sendasset(String walletID, String address, String assetRef, Double quantity, Boolean senderPays) throws com.bitmechanic.barrister.RpcException {
        ...
        com.bitmechanic.barrister.RpcRequest _req = new com.bitmechanic.barrister.RpcRequest(java.util.UUID.randomUUID().toString(), "SparkBitJSONRPCService.sendasset", _params);
        com.bitmechanic.barrister.RpcResponse _resp = this._trans.request(_req);
        if (_resp == null) {
            return null;
        }
    ...
    public JSONRPCWallet[] listwallets() throws com.bitmechanic.barrister.RpcException {
        ...
        if (_resp == null) {
            ...
            return (JSONRPCWallet[])_resp.getResult();
        }
        else {
            throw _resp.getError();
        }
