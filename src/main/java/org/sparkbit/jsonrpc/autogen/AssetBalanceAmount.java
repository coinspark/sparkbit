 ...
 */
public class AssetBalanceAmount implements com.bitmechanic.barrister.BStruct {
    ...
    public static class Builder {
        ...
        public AssetBalanceAmount build() {
            return new AssetBalanceAmount(this._raw, this._qty, this._display);
        }

        public Builder() { }
        public Builder(AssetBalanceAmount obj) {
    ...
    public AssetBalanceAmount() {
        super();
    }

    public AssetBalanceAmount(java.util.Map _map) throws com.bitmechanic.barrister.RpcException {
        this(
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("AssetBalanceAmount:");
    ...
    public boolean equals(Object _other) {
        ...
        if (!(_other instanceof AssetBalanceAmount)) { return false; }
        AssetBalanceAmount _o = (AssetBalanceAmount)_other;
