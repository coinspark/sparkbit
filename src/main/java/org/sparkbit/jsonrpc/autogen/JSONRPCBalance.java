...
public class JSONRPCBalance implements com.bitmechanic.barrister.BStruct {
    ...
    public static class Builder {
        ...
        private JSONRPCBalanceAmount _amount;
        public Builder amount(JSONRPCBalanceAmount amount) { this._amount = amount; return this; }
        private JSONRPCBalanceAmount _total;
        public Builder total(JSONRPCBalanceAmount total) { this._total = total; return this; }
        ...
        public Builder(JSONRPCBalance obj) {
            ...
            this._refreshing = obj.getRefreshing();
        }
    }

    private JSONRPCBalanceAmount total;
    private Boolean valid;
    private String redemption_url;
    private Boolean visible;
    private String[] tracker_urls;
    private JSONRPCBalanceAmount amount;
    ...
    public JSONRPCBalance(java.util.Map _map) throws com.bitmechanic.barrister.RpcException {
        this(
            ...
            (JSONRPCBalanceAmount)com.bitmechanic.barrister.StructTypeConverter.unmarshal(JSONRPCBalanceAmount.class, _map.get("amount"), true),
            (JSONRPCBalanceAmount)com.bitmechanic.barrister.StructTypeConverter.unmarshal(JSONRPCBalanceAmount.class, _map.get("total"), true),
            (JSONRPCBalanceAmount)com.bitmechanic.barrister.StructTypeConverter.unmarshal(JSONRPCBalanceAmount.class, _map.get("spendable"), true),
            ...
            (Boolean)com.bitmechanic.barrister.BoolTypeConverter.unmarshal(_map.get("valid"), false),
            ...
            (Boolean)com.bitmechanic.barrister.BoolTypeConverter.unmarshal(_map.get("visible"), false),
            (Boolean)com.bitmechanic.barrister.BoolTypeConverter.unmarshal(_map.get("refreshing"), false)
        );
    }
    ...
    public JSONRPCBalance(
            ...
            @org.codehaus.jackson.annotate.JsonProperty("amount") JSONRPCBalanceAmount amount, 
            @org.codehaus.jackson.annotate.JsonProperty("total") JSONRPCBalanceAmount total, 
            ...
            @org.codehaus.jackson.annotate.JsonProperty("refreshing") Boolean refreshing) {
        super();
    ...
    public void setTotal(JSONRPCBalanceAmount total) {
        this.total = total;
    }

    public JSONRPCBalanceAmount getTotal() {
        return this.total;
    }
    ...
    public void setAmount(JSONRPCBalanceAmount amount) {
        this.amount = amount;
    }

    public JSONRPCBalanceAmount getAmount() {
        return this.amount;
    }
    ...
    public String toString() {
        ...
        sb.append(" refreshing=").append(refreshing);
    ...
    public boolean equals(Object _other) {
        ...
        if (total == null && _o.total != null) { return false; }
        else if (total != null && !total.equals(_o.total)) { return false; }
        ...
        if (amount == null && _o.amount != null) { return false; }
        else if (amount != null && !amount.equals(_o.amount)) { return false; }
        if (refreshing == null && _o.refreshing != null) { return false; }
        else if (refreshing != null && !refreshing.equals(_o.refreshing)) { return false; }
    ...
    public int hashCode() {
        int _hash = 1;
        _hash = _hash * 31 + (total == null ? 0 : total.hashCode());
        ...
        _hash = _hash * 31 + (amount == null ? 0 : amount.hashCode());
        _hash = _hash * 31 + (refreshing == null ? 0 : refreshing.hashCode());
