...
//import org.coinsparks.CSAssetDatabaseController;
 ...
 * @author jim
 */
public final class SparkBit {

    private static final Logger log = LoggerFactory.getLogger(SparkBit.class);
...
//                }
	    ...
	    localiser = new Localiser(new Locale("en"));
			...
			/* CoinSpark START - adding comment to highlight */
            // Create Assets DB Controller
...
//            AlertManager.INSTANCE.checkVersion();
    ...
    public static void setCoreController(CoreController coreController ) {
        SparkBit.controller = coreController;
        SparkBit.coreController = coreController;
    }

    public static void setBitcoinController(BitcoinController bitcoinController) {
        SparkBit.bitcoinController = bitcoinController;
    }

     public static void setExchangeController(ExchangeController exchangeController) {
        SparkBit.exchangeController = exchangeController;
    }
    ...
    public static void setRememberedRawBitcoinURI(String rememberedRawBitcoinURI) {
        ...
        SparkBit.rememberedRawBitcoinURI = rememberedRawBitcoinURI;
    }
}
