...
#CSPK-SIMON START
#More classes from third-party jars that we want to keep in the stripped down productname-exe.jar.

#http://stackoverflow.com/questions/7464035/how-to-tell-proguard-to-keep-everything
#http://proguard.sourceforge.net/index.html#manual/examples.html

-keep public interface com.jidesoft.**
-keep public class com.jidesoft.**

-keep public interface org.coinspark.**
-keep public class org.coinspark.**
